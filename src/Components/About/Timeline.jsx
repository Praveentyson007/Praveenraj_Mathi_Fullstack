    ...
    <>
      <div className="section mainsection">
        <h2 className="section__title" data-aos="fade-right">
          {" "}
          <span className="different">Projects which I have handled</span>
        </h2>
        <VerticalTimeline lineColor={linecolor}>
          ...
          >
            ...
            <h4
              ...
              data-aos="fade-right"
            >
              e-bliss Technologies.
            </h4>
            <p data-aos="fade-right">
              Full stack design, sign on, authentication and authorization.
              Built web-tier components using spring, Model, Controller and View
              using MAVEN build
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
          ...
          >
            ...
            <p data-aos="fade-right">
              Microservice Architecture with AWS. Developed spring boot Java
              backend applications with ANT build.
            </p>
          </VerticalTimelineElement>
          {/* -----------------aawsoft experience---------------------------------------------
           <VerticalTimelineElement
          ...
          >
            ...
            <p data-aos="fade-right">
              Microservice Architecture with AWS. Built web-tier components
              using spring, Model, Controller and View using MAVEN build
            </p>
          </VerticalTimelineElement> */}
          {/* <VerticalTimelineElement
